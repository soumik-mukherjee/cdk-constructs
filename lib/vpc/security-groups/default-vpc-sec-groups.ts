...
export interface DefaultVpcSecurityGroupsProps {
    vpc: Vpc
    dynamoDbPrefixListId: string
    s3PrefixListId: string
}

export class DefaultVpcSecurityGroups extends Construct {
    readonly vpc: Vpc
    ...
    constructor(scope: Construct, id: string, props: DefaultVpcSecurityGroupsProps) {
        super(scope, id);
        this.vpc = props.vpc;
